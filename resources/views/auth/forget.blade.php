        ...
        <div>
            ...
            <div>
                ...
                <form class="mt-4 space-y-4 lg:mt-5 md:space-y-5" action="#">
                    ...
                    <button type="submit" class="flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600">Reset passwod</button>
                </form>
...
<div
    ...
    <div class="flex items-center justify-center z-1">
        ...
        <div class="flex flex-col items-center max-w-xs">
            <a href="{{route('auth.reg')}}}" class="block mb-4">
