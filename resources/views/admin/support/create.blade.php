    ...
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] p-4">
        <form action="{{ route('support.store') }}" method="POST">
            ...
            <div class="mb-4.5 flex flex-col gap-6 xl:flex-row flex-wrap">
                ...
                <div class="w-full">
                    <label for="customer_name" class="mb-2 block text-sm font-medium text-gray-700 dark:text-white"> Name</label>
                ...
                <div class="w-full">
                    <label for="customer_email" class="mb-2 block text-sm font-medium text-gray-700 dark:text-white"> Email</label>
