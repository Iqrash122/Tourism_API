...
<main>
   ...
   <form id="createCustomer" class="tour-form mx-auto max-w-screen-2xl p-6 my-8" action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
               ...
               <div class="mb-4.5">
                  ...
                  <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent dark:bg-form-input">
                     <select name="role"
                        ...
                        <option value="customer" class="text-body">Customer</option>
                     </select>
                  ...
                  <div class="p-7">
                     <div class="mb-4 flex items-center gap-3">
                        <div class="h-22 w-22 rounded-full">
                           <img src="{{ asset('/images/front/placeholder.jpg') }}" alt="User" class="w-22 h-22 rounded-full" id="avatarPreview" />
                        </div>
                        <div>
