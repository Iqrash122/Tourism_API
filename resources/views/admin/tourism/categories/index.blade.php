               ...
               <div class="col-span-12 flex flex-col">
                    <div class="grid grid-cols-7 rounded-2xl border dark:text-white border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                         <div class="p-2.5 xl:p-5">
                              <h5 class="text-sm font-medium uppercase">ID</h5>
                         </div>
                         <div class="p-2.5 xl:p-5">
                              <h5 class="text-sm font-medium uppercase">Name</h5>
                         </div>
                         <div class="hidden p-2.5 text-center sm:block xl:p-5">
                              <h5 class="text-sm font-medium uppercase">Slug</h5>
                         </div>
                         <div class="hidden p-2.5 text-center sm:block xl:p-5">
                              <h5 class="text-sm font-medium uppercase">Description</h5>
                         </div>
                         <div class="p-2.5 text-center xl:p-5">
                              <h5 class="text-sm font-medium uppercase">Icon</h5>
                         </div>
                         <div class="p-2.5 text-center xl:p-5">
                              <h5 class="text-sm font-medium uppercase">Banner</h5>
                         </div>
                         <div class="p-2.5 text-center xl:p-5">
                              <h5 class="text-sm font-medium uppercase">Action</h5>
                         </div>
                    </div>
                    ...
                    <div class="grid grid-cols-7  dark:text-white border-gray-200 ">
                         ...
                         {{-- Slug --}}
                         <div class="hidden p-2.5 text-center sm:block xl:p-5">
                              <p class="text-sm">{{ $cat->slug }}</p>
                         </div>

                         {{-- Description --}}
                         <div class="hidden p-2.5 text-center sm:block xl:p-5">
                              <p class="text-sm truncate">{{ $cat->description }}</p>
                         </div>

                         {{-- Icon --}}
                         <div class="p-2.5 text-center xl:p-5">
                              @if($cat->icon_path)
                              <img src="{{ asset('storage/'.$cat->icon_path) }}"
                                   alt="Icon"
                         ...
                         <div class="p-2.5 text-center xl:p-5">
                              @if($cat->banner_path)
                              <img src="{{ asset('storage/'.$cat->banner_path) }}"
                                   alt="Banner"
                         ...
                         <div class="p-2.5 text-center xl:p-5 flex justify-center gap-2">
                              ...
                              <a href="{{ route('category.edit', $cat->id) }}"
                                   class="w-12 h-7 inline-flex items-center justify-center text-sm text-white bg-blue-600 rounded hover:bg-blue-700">
                                   Edit
                              </a>
                    ...
                    <p class="p-5 text-center text-gray-500">No categories found.</p>
                    @endif
