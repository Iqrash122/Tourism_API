                ...
                <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between   dark:text-white/90">
                    ...
                    <nav>
                        <ol class="flex items-center gap-2">
                            ...
                            <li class="font-medium text-success capitalize">Edit Category</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="p-6.5">
                        <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                            ...
                            <div class="w-full xl:w-1/2">
                                ...
                                <input type="text" id="slug" name="categorySlug" value="{{ $category->slug }}"
                        ...
                        <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                            <div class="w-full xl:w-1/2">
                                ...
                                <img src="{{ asset('storage/' . $category->icon_path) }}" class="h-10 w-10 mb-2" />
                                @endif
                            ...
                            <div class="w-full xl:w-1/2">
                                ...
                                <img src="{{ asset('storage/' . $category->banner_path) }}" class="h-10 w-20 mb-2" />
                                @endif
