...
<main>
        ...
        <div class=" flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <nav>
                <ol class="flex items-center gap-2">
                    ...
                    <li class="font-medium text-success capitalize">Edit Tourism</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <form id="tourForm" class="tour-form mx-auto max-w-screen-2xl p-6  " method="POST" action="{{ route('tourism.update',$tour->id) }}" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="space-y-6  border-gray-100 p-5 sm:p-6 dark:border-gray-800">
                        ...
                        <div class="flex flex-row gap-4">
                            <div class="w-1/2">
                                ...
                                <input id="bookingTitle" type="text" placeholder="Enter Activity Title" name="activity_title" value="{{ $tour->activity_title }}"
                            ...
                            <div class="w-1/2">
                                ...
                                <input id="slug" type="text" placeholder="Auto-generated or manual slug" name="activity_slug" value="{{ $tour->activity_slug }}"
                        ...
                        <div class="flex flex-row gap-4">
                            <div class="w-1/2">
                                ...
                                <input
                                    type="text" placeholder="Enter Title" name="seo_title" value="{{ $tour->seo_title }}"
                            ...
                            <div class="w-1/2">
                                ...
                                <input
                                    placeholder="Keywords" name="seo_keywords" value="{{ $tour->seo_keywords }}"
                                    class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                type="text"
                                rows="6" name="seo_description" value="{{ $tour->seo_description }}"
                                class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"></textarea>
                        </div>

                        <!-- price variation -->
                        <fieldset class="space-y-8"
                            x-data="variationForm({ 
                                    priceVariations: {{ json_encode($priceVariations) }}, 
                                    timeVariations: {{ json_encode($timeVariations) }} 
                                })"
                            x-init="serialize()"
                            @input.debounce.300ms="serialize()"> <!-- Price Details Section -->
                            <div class="space-y-4">
                                <div class="flex items-center justify-between">
                                    ...
                                    <button
                                        type="button"
                                        @click="priceVariations.push({ title: '', regular: '', sale: '' })"
                                        class="px-4 py-2 text-sm font-medium text-white bg-brand-500 rounded-lg hover:bg-brand-600 transition">
                                        + Add Variation
                                    </button>
                                </div>

                                <template x-for="(variation, index) in priceVariations" :key="index">
                                    <div class="flex flex-row gap-4 items-end">
                                        ...
                                        <div>
                                            <template x-if="priceVariations.length > 1">
                                                <button type="button" @click="priceVariations.splice(index, 1)"
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center justify-between">
                                    ...
                                    <button
                                        type="button"
                                        @click="timeVariations.push({ title: '', start: '', end: '' })"
                                        class="px-4 py-2 text-sm font-medium text-white bg-brand-500 rounded-lg hover:bg-brand-600 transition">
                                        + Add Time
                                    </button>
                                </div>

                                <template x-for="(time, index) in timeVariations" :key="'time-' + index">
                                    <div class="flex flex-row gap-4 items-end">
                                        ...
                                        <div>
                                            <template x-if="timeVariations.length > 1">
                                                <button type="button" @click="timeVariations.splice(index, 1)"
                                                    class="px-3 py-2 text-xs font-medium text-white bg-red-500 rounded-lg hover:bg-red-600 transition">Remove</button>
                                            </template>
                                        </div>
                                    </div>
                        ...
                        <textarea name="body" id="body" class="form-control">{{$tour->body}}</textarea>
                        ...
                        <div class="flex flex-row gap-4 mt-6">
                            ...
                            $selectedCategories = parseIds($tour->activity_categories);
                            $selectedCities = parseIds($tour->activity_cities);
                            @endphp
                        ...
                        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                            <div class="space-y-6 border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
                                ...
                                <div class="flex flex-wrap items-center gap-8">
                                    <div x-data="{ checkboxToggle: {{$tour->feature_offers ? 'true' : 'false'}} }">
                                        <label for="checkboxLabelOne"
                                            class="flex cursor-pointer items-center text-sm font-medium text-gray-700 select-none dark:text-gray-400">
                                            <div class="relative">
                                                <input type="checkbox" name="feature_offers" id="checkboxLabelOne" class="sr-only"
                                                    value="{{$tour->feature_offers}}"
                                                    x-bind:checked="checkboxToggle"
                                    ...
                                    <div x-data="{ checkboxToggle: {{$tour->promotion_tours ? 'true' : 'false'}} }">
                                        <label for="checkboxLabelTwo"
                                            class="flex cursor-pointer items-center text-sm font-medium text-gray-700 select-none dark:text-gray-400">
                                            <div class="relative">
                                                <input type="checkbox" name="promotion_tours" id="checkboxLabelTwo" value="{{$tour->promotion_tours}}"
                                                    class="sr-only" x-bind:checked="checkboxToggle" @change="checkboxToggle = !checkboxToggle" />
                                                <div :class="checkboxToggle ? 'border-brand-500 bg-brand-500' : 'bg-transparent border-gray-300 dark:border-gray-700'"
                                                    class="hover:border-brand-500 dark:hover:border-brand-500 mr-3 flex h-5 w-5 items-center justify-center rounded-md border-[1.25px]">
                                                    <span :class="checkboxToggle ? '' : 'opacity-0'">
                                                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div x-data="{ checkboxToggle: {{$tour->top_rated ? 'true' : 'false'}} }">
                                        <label for="checkboxLabelThree"
                                            class="flex cursor-pointer items-center text-sm font-medium text-gray-700 select-none dark:text-gray-400">
                                            <div class="relative">
                                                <input type="checkbox" name="top_rated" id="checkboxLabelThree" value="{{$tour->top_rated}}"
                                                    class="peer sr-only" x-bind:checked="checkboxToggle" @change="checkboxToggle = !checkboxToggle" />
                                                <div :class="checkboxToggle ? 'border-brand-500 bg-brand-500' : 'bg-transparent border-gray-300 dark:border-gray-700'"
                                                    class="hover:border-brand-500 dark:hover:border-brand-500 mr-3 flex h-5 w-5 items-center justify-center rounded-md border-[1.25px]">
                                                    <span :class="checkboxToggle ? '' : 'opacity-0'">
                                                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="space-y-6">
                                    ...
                                    <ul id="gallery" class="flex flex-1 flex-wrap -m-1">
                                        ...
                                        <li class="block p-1 w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/6 xl:w-1/8 h-24">
                                            <article tabindex="0" class="group hasImage w-full h-full rounded-md focus:outline-none focus:shadow-outline bg-gray-100 cursor-pointer relative text-transparent hover:text-white shadow-sm">
                                                <img alt="tour image" class="img-preview w-full h-full sticky object-cover rounded-md bg-fixed"
                ...
                <div
                    ...
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        ...
                        <div x-data="{ rating: {{$tour->rating_bar ?? 0}}, hoverRating: 0 }" class="flex space-x-1 text-yellow-400 my-3">
                    ...
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <label for="yt_url" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                            YouTube URL
                        </label>
                        <div class="relative">
                            <span
                            ...
                            <input
                                ...
                                name="yt_url"
                                id="yt_url"
                                value="{{ old('yt_url', $tour->yt_url) }}"
                                placeholder="youtube.com/watch?v=..."
                                class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 pl-[95px] text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-none dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                        </div>
                    </div>
                    ...
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        ...
                        <input type="text" id="locationInput" placeholder="Enter city or country" name="activity_location" value="{{$tour->activity_location}}"
...
<script>
    function variationForm(initialData = {
        priceVariations: [],
        timeVariations: []
    }) {
        return {
            priceVariations: initialData.priceVariations || [],
            timeVariations: initialData.timeVariations || [],
            serialized: '',
            ...
            submitForm() {
                this.serialize();
                // submit the form manually or use normal submit:
                // document.querySelector('form').submit();
                // Or just rely on normal submit button
            }
        }
    }
    ...
    gallery.onclick = ({
        ...
        if (target.classList.contains("delete")) {
            ...
            delete FILES[ou];
            URL.revokeObjectURL(ou); // Add this line
