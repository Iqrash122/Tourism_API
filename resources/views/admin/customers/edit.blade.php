...
{{-- Edit  Customer Tour Main Section --}}
<main>
        ...
        <div class=" flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <nav>
                <ol class="flex items-center gap-2">
                    ...
                    <li class="font-medium text-success capitalize"> Edit Customer</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="p-6.5">
                    ...
                    <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                        ...
                        <div class="w-full xl:w-1/2">
                            ...
                            <div class="relative max-w-sm">
                                ...
                                <input id="dateofbirth-format" type="date" id="dob" name="dob"
                    ...
                    <div class="mb-6 ">
                        ...
                        <textarea name="bio" rows="5" placeholder="Bio" maxlength="255"
                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"> {{ $customer->customer->bio }} </textarea>
                    </div>
                        ...
                        <div class="p-7">
                            <div class="mb-15 flex items-center gap-3">
                                <div class="h-22 w-22 rounded-full">
                                    <img alt="PlaceHolder" class="w-22 h-22 rounded-full" id="avatarPreview"
                                        src="{{ $customer->profile_picture ? asset('storage/' . $customer->profile_picture) : asset('/images/front/placeholder.jpg') }}">
